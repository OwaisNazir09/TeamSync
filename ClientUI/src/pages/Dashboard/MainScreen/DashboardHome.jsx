        ...
        <div className="p-4 bg-gray-50 min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white shadow-md rounded-lg overflow-hidden col-span-1 lg:col-span-2">
                    <div className="bg-gradient-to-r from-blue-600 to-blue-100 py-3 px-4">
                ...
                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                    <div className="bg-gradient-to-r from-green-500 to-green-100 py-3 px-4">
                ...
                {/* Calendar Card */}
                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                    <div className="bg-gradient-to-r from-purple-500 to-purple-100 py-3 px-4">
                        <h2 className="text-lg font-semibold text-white flex items-center">
                ...
                {/* Personal Notes Card */}
                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                    <div className="bg-gradient-to-r from-yellow-600 to-yellow-100 py-3 px-4">
